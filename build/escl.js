...
define('escl/tlist',[],function () {
    ...
    return {
        ...
        enableRequest: function (enablePageUrl, record) {
            return $j.get(enablePageUrl);
        },

        sendRequest: function (tlistParamData) {
            return $j.ajax({
                data: tlistParamData,
                type: "POST",
...
define('escl',['require','escl/api','escl/tlist','escl/record'],function(require) {
    var api = require('escl/api'),
        tlist = require('escl/tlist'),
        record = require('escl/record');
